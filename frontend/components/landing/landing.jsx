...
const Landing = (props) => {
    ...
    const covers = (
        <div className='landing-covers'>
            <button className='landing-cover' onClick={handleClick}>
    ...
    return (
        <div className='landing-div'>
            ...
            <div className='landing-closing'>
                ...
                <button className='landing-btn-orn' onClick={handleClick}>Create account</button>
                <span className='landing-signin'>
                    <p id='already-account'>Already have an account?</p> 
                    <button className='landing-btn-wht' onClick={handleClick}>Sign in</button>
                </span>
            </div>
        </div>
    )
